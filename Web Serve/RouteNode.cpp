...
std::string RouteNode::getFullResponse() noexcept {
	std::cout << "Response: " << this->determineResponse() << std::endl;
	return this->determineResponseStatus() + this->determineContentType() + this->determineResponse();
}

std::string RouteNode::determineResponseStatus() const noexcept {
...
std::string RouteNode::determineContentType() const noexcept {
